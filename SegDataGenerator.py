...
class SegDataGenerator(object):
    ...
    def flow_from_directory(self, directory, subset,
    ...
    def elastic_transform(self, img):
        ...
        rand_affine = random_state.uniform(-alpha_affine, alpha_affine,
...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator, 
        ...
        if self.subset == 'training':
            ...
            labels = npzfile['Y_train']
            num_images = len(images)
            self.images = images[0:int((1-validation_split)*num_images-1)]
            self.labels = labels[0:int((1-validation_split)*num_images-1)]
            ...
            labels = npzfile['Y_train']
            num_images = len(images)
            self.images = images[int((1-validation_split)*num_images):]
            self.labels = labels[int((1-validation_split)*num_images):]
            if self.use_contour == True:
                contours = npzfile['C_train']
